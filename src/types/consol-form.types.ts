...
export const MOCK_PORTS = ['INMUN - Mundra', 'INNSA - Nhava Sheva', 'INCHE - Chennai', 'CNSHA - Shanghai', 'CNNGB - Ningbo', 'SGSIN - Singapore', 'USLAX - Los Angeles', 'USNYC - New York', 'GBFXT - Felixstowe', 'DEHAM - Hamburg', 'AEJEA - Jebel Ali'];
